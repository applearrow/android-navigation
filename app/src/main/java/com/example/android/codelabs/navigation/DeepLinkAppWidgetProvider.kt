...
class DeepLinkAppWidgetProvider : AppWidgetProvider() {
    override fun onUpdate(
        ...
        // By default NavDeepLinkBuilder will start your launcher Activity. You can override this
        // behavior by passing in an activity as the context or set an explicit activity class via
        // setComponentName().
